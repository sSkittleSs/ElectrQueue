...
namespace ElectrQueue {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ âõîäÂÀäìèíïàíåëüToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->âõîäÂÀäìèíïàíåëüToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->ôàéëToolStripMenuItem,
					this->îáÀâòîğåToolStripMenuItem, this->âûõîäToolStripMenuItem, this->âõîäÂÀäìèíïàíåëüToolStripMenuItem
			});
			...
			this->âûõîäToolStripMenuItem->Size = System::Drawing::Size(136, 20);
			this->âûõîäToolStripMenuItem->Text = L"Âõîä â àäìèí-ïàíåëü";
			// 
			...
			// 
			// âõîäÂÀäìèíïàíåëüToolStripMenuItem
			// 
			this->âõîäÂÀäìèíïàíåëüToolStripMenuItem->Name = L"âõîäÂÀäìèíïàíåëüToolStripMenuItem";
			this->âõîäÂÀäìèíïàíåëüToolStripMenuItem->Size = System::Drawing::Size(54, 20);
			this->âõîäÂÀäìèíïàíåëüToolStripMenuItem->Text = L"Âûõîä";
			this->âõîäÂÀäìèíïàíåëüToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::TopCenter;
			// 
			// MyForm
			// 
			...
			this->ClientSize = System::Drawing::Size(697, 500);
			this->Controls->Add(this->menuStrip1);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::FixedSingle;
			this->MainMenuStrip = this->menuStrip1;
			this->Name = L"MyForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Electronic Queue";
